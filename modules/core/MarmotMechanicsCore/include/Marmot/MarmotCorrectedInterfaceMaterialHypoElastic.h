 ...
 */
class MarmotCorrectedInterfaceMaterialHypoElastic {
...
public:
  ...
  MarmotCorrectedInterfaceMaterialHypoElastic( const std::string& materialName,
                                               const double*      matProperties_,
                                               int                nMaterialProperties_,
                                               int                materialNumber_ );

  virtual ~MarmotCorrectedInterfaceMaterialHypoElastic() = default;
