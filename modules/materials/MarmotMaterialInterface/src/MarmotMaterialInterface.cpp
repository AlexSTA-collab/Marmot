#include "../include/Marmot/MarmotMaterialInterface.h"
...
void MarmotMaterialInterface::assignStateVars( double* stateVars, int nStateVars )
  {
    ...
    managedStateVars = std::make_unique< MarmotMaterialInterfaceStateVarManager >( stateVars );
  }
...
void MarmotMaterialInterface::computeStress(Tensor1D&  force,
...
int main() {
    ...
    Fastor::Tensor<double, 6,1> dU(0.f);
    Fastor::Tensor<double, 18,1> dSurface_strain(0.1);
