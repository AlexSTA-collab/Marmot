...
namespace Marmot::Materials {
  ...
  // clang-format on
  {
    ...
    elasticModuli_Ju = KelvinChainInterface::computeElasticModuli<powerLawApproximationOrder>(phiJu_, retardationTimes_Ju);
    elasticModuli_Js = KelvinChainInterface::computeElasticModuli<powerLawApproximationOrder>(phiJs_, retardationTimes_Js);
                                                   ...
                                                   double&       pNewDT)
  {
    ...
    double barC_Ju = 1./E_eff + zerothKelvinChainCompliance_Ju + creep_Ju_compliance;
    double barC_Js = 1./E_eff + zerothKelvinChainCompliance_Js + creep_Js_compliance;
    
    auto [H_inv_ij_effective, Z_ijkl_effective] = calculate_effective_properties(barC_Ju, barC_Js, normal_ftensor, E_eff, nu_eff);
    ...
    Fastor::Tensor<double, 3>  deltaforce_i = Fastor::einsum<Fastor::Index<i,j>, Fastor::Index<j>, Fastor::OIndex<i>>(H_inv_ij_effective, (jumpU_ftensor-creep_Ju_increment_fastor));

    Fastor::TensorMap<double,3,3> creep_Js_increment_fastor(creep_Js_Increment.data()); 
    Fastor::Tensor<double,3,3> deltasurface_stress_ij = Fastor::einsum<Fastor::Index<i,j,k,l>,Fastor::Index<k,l>, Fastor::OIndex<i,j>>(Z_ijkl_effective, (average_dSurface_strain_ftensor_reshape-creep_Js_increment_fastor)); 
